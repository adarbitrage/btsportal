...
ALTER TABLE "communication_log" ADD CONSTRAINT "communication_log_broadcast_id_broadcasts_id_fk" FOREIGN KEY ("broadcast_id") REFERENCES "public"."broadcasts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "communication_log" ADD CONSTRAINT "communication_log_sequence_id_sequences_id_fk" FOREIGN KEY ("sequence_id") REFERENCES "public"."sequences"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "email_template_versions" ADD CONSTRAINT "email_template_versions_saved_by_users_id_fk" FOREIGN KEY ("saved_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "sequence_enrollments" ADD CONSTRAINT "sequence_enrollments_current_step_id_sequence_steps_id_fk" FOREIGN KEY ("current_step_id") REFERENCES "public"."sequence_steps"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "communication_log_broadcast_id_idx" ON "communication_log" USING btree ("broadcast_id");--> statement-breakpoint
CREATE INDEX "communication_log_sequence_id_idx" ON "communication_log" USING btree ("sequence_id");--> statement-breakpoint
...
CREATE INDEX "email_template_versions_template_id_idx" ON "email_template_versions" USING btree ("template_id");--> statement-breakpoint
