...
const RAW_SECTIONS: Omit<BlitzSection, "courseId">[] = [
  ...
  { id: 12, phase: "build", step: "MetricMover™",              title: "Using MetricMover™",                                                                      sectionAnchor: "s8b" },
  { id: 13, phase: "build", step: "DIYTrax Setup",             title: "Set Up DIYTrax",                                                                          sectionAnchor: "s9"  },
