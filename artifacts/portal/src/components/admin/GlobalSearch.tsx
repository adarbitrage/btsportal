              ...
              {results.members?.length > 0 && (
                <div className="p-2">
                  ...
                  {results.members.map((m: any) => (
                    <button key={m.id} onClick={() => goTo(`/admin/members/${m.id}`)} className="w-full flex items-center gap-3 px-2 py-2 rounded hover:bg-muted/50 text-left transition-colors">
