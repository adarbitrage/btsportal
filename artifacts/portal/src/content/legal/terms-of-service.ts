...
// Source: attached_assets/Pasted--TERMS-OF-SERVICE-Build-Test-Scale-LLC-Effective-Date-O_1786026895503.txt
export const termsOfServiceTitle = "Terms of Service";
export const termsOfServiceBody = `TERMS OF SERVICE
Build. Test. Scale., LLC
Effective Date: October 1, 2025

1. ACCEPTANCE AND MODIFICATION OF TERMS
1.1 Agreement to Terms
By accessing, browsing, or using the website located at https://buildtestscale.com (the "Website") or any services provided through the Website, you ("User," "you," or "your") acknowledge that you have read, understood, and agree to be bound by these Terms of Service ("Terms" or "Agreement") and all applicable laws and regulations. If you do not agree to these Terms, you must immediately discontinue use of the Website and all related services.

1.2 Binding Agreement
These Terms constitute a legally binding agreement between you and Build. Test. Scale., LLC, a Texas limited liability company ("Company," "we," "us," or "our"). Your use of the Website constitutes acceptance of these Terms, regardless of whether you create an account or make a purchase.
...
5.3 Refund Policy
We offer a thirty (30) day, no questions asked refund policy for all digital products. To request a refund, you must contact us at support@buildtestscale.com within thirty (30) days of your purchase date. Refunds will be processed using the same payment method used for the original purchase and may take five (5) to ten (10) business days to appear on your account statement.
...
8.1 Texas Data Privacy and Security Act Compliance
The Company complies with the Texas Data Privacy and Security Act (Chapter 541, Texas Business and Commerce Code) ("TDPSA") in its collection, use, and disclosure of personal information. This section provides the privacy disclosures required under Section 541.02 of the TDPSA.
