...
// Source: attached_assets/Pasted--DMCA-POLICY-Effective-Date-October-1-2025-1-INTRODUCTI_1786027039376.txt
export const dmcaPolicyTitle = "DMCA Policy";
export const dmcaPolicyBody = `DMCA POLICY
Effective Date: October 1, 2025

1. INTRODUCTION AND SCOPE
This Digital Millennium Copyright Act ("DMCA") Policy is established by Build. Test. Scale., LLC ("Company," "we," "us," or "our") in compliance with the Digital Millennium Copyright Act of 1998, 17 U.S.C. § 512, and the Online Copyright Infringement Liability Limitation Act (OCILLA), 17 U.S.C. § 512.

This Policy applies to all content displayed, transmitted, or otherwise made available on or through our website located at https://buildtestscale.com (the "Website"). The Website primarily consists of static content created and owned by the Company, including but not limited to images, videos, text, landing pages, advertisements, banner advertisements, and animated GIFs.
...
Governing Law
This Policy shall be governed by and construed in accordance with the laws of the State of Texas and applicable federal laws of the United States, without regard to its conflict of law provisions. The federal and state courts located in Austin, Texas shall have exclusive jurisdiction over any disputes arising under or related to this Policy.
