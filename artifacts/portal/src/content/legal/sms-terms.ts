...
// Source: attached_assets/Pasted--SMS-TERMS-AND-CONDITIONS-Effective-Date-December-26-20_1786027146983.txt
export const smsTermsTitle = "SMS Terms and Conditions";
export const smsTermsBody = `SMS TERMS AND CONDITIONS
Effective Date: December 26, 2025

Program Disclosure
By opting in, you agree to receive SMS messages from Build. Test. Scale., LLC, including alerts, promotional offers, account and order updates, coaching and program notifications, and other marketing communications related to our affiliate marketing mentorship program and services. Message frequency varies; you may receive up to 8 messages per month.
...
Build Test Scale SMS Terms & Conditions
SMS Program Description
Build Test Scale offers an SMS messaging program that provides updates regarding your account, waitlist status, customer support, appointments, services, and, where separately consented to, promotional offers and marketing communications. Message frequency varies.

Opt-In
By providing your mobile phone number and giving the appropriate consent, you agree to receive SMS messages from Build Test Scale.

Opt-Out
You may opt out at any time by replying STOP to any message. You will receive a final confirmation message confirming your opt-out.

Help
Reply HELP for assistance or contact us at:

support@buildtestscale.com
https://buildtestscale.com
...
We may send text messages from multiple phone numbers or short codes. Each message will clearly identify that it is from Build. Test. Scale., LLC. You acknowledge that the specific phone number from which you receive messages may change over time.
...
4.2 Messaging Hours
In accordance with Texas SB 140 and the Federal Trade Commission's Telemarketing Sales Rule, 16 CFR Part 310, we will only send text messages during the following hours:
...
Message and data rates may apply. Check with your carrier for details. These rates and charges are determined by your mobile carrier and are your sole responsibility. We do not charge you for sending or receiving text messages, but your carrier may charge you for each text message you send to us or receive from us.
...
Carriers are not liable for delayed or undelivered messages. We are also not responsible for delayed or undelivered messages due to carrier issues, network problems, or device incompatibilities. If you have concerns about message delivery or charges, please contact your mobile carrier directly.
...
Notwithstanding the foregoing, either you or the Company may bring an individual action in small claims court in Collin County, Texas, provided that such action is within the jurisdiction of the small claims court.
...
Posting the revised Terms on our website at https://buildtestscale.com/sms-terms-and-conditions
...
10.4 Prior Versions
We will maintain an archive of prior versions of these Terms for a period of at least four (4) years. You may request access to prior versions of these Terms by contacting us at support@buildtestscale.com.
...
11.2 Texas State Compliance
Our SMS messaging program complies with all applicable Texas state laws and regulations, including but not limited to:

Texas Business & Commerce Code Chapter 302
Texas SB 140 regarding timing restrictions for text messages
11.3 Registration Exemption
We believe we qualify for the customer exemption from telemarketer registration requirements under Texas Business & Commerce Code Chapter 302, as our text messages are sent primarily to existing customers with whom we have an established business relationship.
...
11.5 Governing Law
These Terms shall be governed by and construed in accordance with the laws of the State of Texas, without giving effect to any principles of conflicts of law. Any dispute arising from or relating to these Terms shall be subject to the exclusive jurisdiction of the state and federal courts located in Collin County, Texas, subject to the arbitration provisions in Section 8 of these Terms.
