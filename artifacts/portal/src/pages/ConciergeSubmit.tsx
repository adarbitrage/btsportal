...
import {
  ...
  AlertCircle, Upload, AlertTriangle, X, RotateCw, Loader2,
  ArrowLeft,
} from "lucide-react";
      ...
      <Card className="border-border/60 shadow-sm">
        <CardContent className="p-8 text-center space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mt-4">
            ...
            <Link href="/concierge">
              <Button variant="ghost" data-testid="concierge-back-to-submissions">
...
// The Concierge intake page. Reached from the Concierge landing page's
// "Submit a Task" button (mirrors how Compliance Review routes to
// /compliance/submit). Houses the full task-intake form.
export default function ConciergeSubmit() {
  return (
    <AppLayout>
      <div className="space-y-6 max-w-6xl">
        <div>
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <h1 className="text-3xl font-bold">Submit A Task For The Concierge™</h1>
          </div>
          <p className="text-muted-foreground">
