...
const LESSON_LOOKUP: Record<number, { section: string; label: string }> = {
  ...
  9: { section: "s6d", label: "Phase 1 — Landing Page Assets · ClickBank / MaxWeb" },
  ...
  <div class="card">
    ...
    <ol class="step-list">
      ...
      <li><div class="step-num">3</div><div class="step-body"><strong>Add DIYTrax LP Offer Link to Your Landing Pages</strong> — use the Custom Value method first; there's a backup method if needed
        <div class="video-slot" data-vidalytics-id="8dx0ftVuvNUxxiLl" data-status="ready" style="margin-top:10px;"><div class="play-icon"></div><div><div class="vt">Add DIYTrax LP Offer Link in Flexy Custom Value</div><div class="vd">Preferred method — use this first; a backup method is available if needed</div></div></div>
      </div></li>
...
<span id="s15" style="display:block;position:relative;top:-80px;visibility:hidden;"></span><div class="module" id="blitz-between-r2-r3" data-section="s15">
  ...
  <div class="card">
    ...
    <div class="video-slot" data-vidalytics-id="4MW15NDvkIFuSZ9P" data-status="ready"><div class="play-icon"></div><div><div class="vt">V3 — How to Trim Video Length Using Adobe Express</div><div class="vd">Cut videos to the right length before converting to GIF</div></div></div>
    <div class="video-slot" data-vidalytics-id="b377d5GfR9zBawPr" data-status="ready"><div class="play-icon"></div><div><div class="vt">V4 — How to Convert Videos to GIFs Using Adobe Express</div><div class="vd">Create animated GIFs from your video files</div></div></div>
    <div class="video-slot" data-vidalytics-id="mQzZ7M9qOS6CNRmn" data-status="ready"><div class="play-icon"></div><div><div class="vt">V5 — How to Reduce GIF File Size Under 5MB Using GIFSTER</div><div class="vd">Compress your GIFs so they meet Caterpillar's file size requirements</div></div></div>
    <div class="video-slot" data-vidalytics-id="ezlIzQmdshnlKwkE" data-status="ready"><div class="play-icon"></div><div><div class="vt">V6 — How to Convert Videos to GIFs Using GIFSTER</div><div class="vd">Alternative GIF creation method using GIFSTER</div></div></div>
  </div>
