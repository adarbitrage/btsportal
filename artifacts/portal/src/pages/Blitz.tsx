...
<div class="module" id="blitz-step5" data-section="s10">
  ...
  <div class="video-slot" data-vidalytics-id="aswGPSkz_Y1UbT1g" data-status="ready"><div class="play-icon"></div><div><div class="vt">T7 — Place Affiliate Link in DIYTrax Campaign Offer Pages</div><div class="vd">Add your affiliate link so DIYTrax knows where to send buyers</div></div></div>
...
<span id="s15" style="display:block;position:relative;top:-80px;visibility:hidden;"></span><div class="module" id="blitz-between-r2-r3" data-section="s15">
  ...
  <div class="card">
    ...
    <div class="video-slot" data-vidalytics-id="uRjbZx71u3BMvrY8" data-status="ready"><div class="play-icon"></div><div><div class="vt">V6 — How to Convert Videos to GIFs Using EZgif</div><div class="vd">Alternative GIF creation method using GIFSTER</div></div></div>
  </div>
