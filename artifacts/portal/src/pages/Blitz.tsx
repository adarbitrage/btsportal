...
<div class="module" id="blitz-step3" data-section="s8">
  ...
  <div class="path-block mm">
    ...
    <div class="callout-box" style="margin-bottom:16px;">
      <div class="pe-label">💡 What Do These 13 Steps Actually Accomplish?</div>
      The MM1–MM13 video series walks you through one complete task: taking your 5 landing page headlines and 5 hero shot images and turning them into 25 live, trackable landing page combinations that rotate automatically for every visitor.
    </div>
    <div class="video-slot" data-vidalytics-id="n413KFVaotcczNzk" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">MM1 — What You Need For A MetricMover™ Test</div><div class="vd">Overview of assets and setup requirements before you begin</div></div></div>
    <div class="video-slot" data-vidalytics-id="l0TgiVD_OdVGOU6F" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">MM2 — Creating A New MetricMover™ Campaign</div><div class="vd">Set up your campaign in the MetricMover™ App</div></div></div>
    <div class="video-slot" data-vidalytics-id="UEiQJPY24RnBOfGx" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">MM3 — How To Import Your Landing Page Into MetricMover™</div><div class="vd">Bring your Flexy™ advertorial page into the MetricMover™ App</div></div></div>
    <div class="video-slot" data-vidalytics-id="BB7O9GHighklpI3O" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">MM4 — How To Create Headline Variants</div><div class="vd">Enter your 5 headlines into MetricMover™</div></div></div>
    <div class="video-slot" data-vidalytics-id="_c7Qa_byz0CfONui" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">MM5 — How To Upload Hero Shots To Flexy™</div><div class="vd">Add your 5 hero shot images to your Flexy™ media library</div></div></div>
    <div class="video-slot" data-vidalytics-id="qkPlOP6igjZmTCsU" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">MM6 — How To Create Hero Shot Variants</div><div class="vd">Assign your hero shots as variants in MetricMover™</div></div></div>
    <div class="video-slot" data-vidalytics-id="fG6txxvBGHX_I0P2" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">MM7 — How To Set Up A Flexy™ Page For MetricMover™ Code</div><div class="vd">Prepare your landing page to receive the MetricMover™ code</div></div></div>
    <div class="video-slot" data-vidalytics-id="B9N7Nq7HExNNT7sq" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">MM8 — How To Export MetricMover™ Campaign Files</div><div class="vd">Download your campaign files from the MetricMover™ App</div></div></div>
    <div class="video-slot" data-vidalytics-id="Gyuer8rxri5u3c0b" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">MM9 — How To Find Your MetricMover™ Code File</div><div class="vd">Locate the code file within your exported campaign files</div></div></div>
    <div class="video-slot" data-vidalytics-id="ROrMoUEMt02rNHsp" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">MM10 — How To Embed MetricMover™ Code Into A Flexy™ Page</div><div class="vd">Paste the code into your Flexy™ page to activate the split test</div></div></div>
    <div class="video-slot" data-vidalytics-id="fk8imXc3X0oFntJC" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">MM11 — How To Check MetricMover™ Page Variants</div><div class="vd">Verify that all 25 combinations are displaying correctly</div></div></div>
    <div class="video-slot" data-vidalytics-id="nfxAtCnkhY7LSoud" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">MM12 — How To Find Your MetricMover™ .csv File For DIYTrax™ Import</div><div class="vd">Locate the file you'll need for the next step</div></div></div>
    <div class="video-slot" data-vidalytics-id="7rsmtTDD2Nq68qlY" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">MM13 — How To Import MetricMover™ Page Variants Into DIYTrax™</div><div class="vd">Load all 25 landing page variants into your DIYTrax campaign</div></div></div>
  </div>

  <div class="path-block cb">
    <div class="path-block-label">✦ ClickBank / MaxWeb / Affiliati (jump page) — MetricMover™ Setup</div>
    <div class="callout-box"><div class="pe-label">💡 How this works</div>The ClickBank/MaxWeb path now follows the same MetricMover™ process as Media Mavens. Start by cloning a jump page template in Flexy™ and customizing the body copy for your offer. Then follow the MM1–MM13 video series to set up MetricMover™ with your 5 headlines and 5 hero shots — generating 25 combinations that are imported directly into DIYTrax for split testing. One Flexy™ page holds the MetricMover™ embed code.</div>
...
<div class="module" id="blitz-step5" data-section="s10">
  ...
  <div class="video-slot" data-vidalytics-id="FW_zSFg85RDWHUOf" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">T1 — Caterpillar Campaign Basic Info</div><div class="vd">Setting up the basic campaign details in DIYTrax</div></div></div>
  <div class="video-slot" data-vidalytics-id="FwUJLd9L5HAonTB1" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">T2 — Configure Caterpillar Traffic Source Settings</div><div class="vd">Connect and configure your Caterpillar publisher settings</div></div></div>
  <div class="video-slot" data-vidalytics-id="a_AOXzP900ghMtxg" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">T3 — Create Your First Native Ad in Caterpillar</div><div class="vd">Upload your first headline, description, and image</div></div></div>
  <div class="video-slot" data-vidalytics-id="zP9oZsPJgMgXTUKJ" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">T4 — Create More Ads in Caterpillar</div><div class="vd">Add your remaining headlines to complete all 10 ads</div></div></div>
  <div class="video-slot" data-vidalytics-id="asSx55NQbclVdP89" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">T5 — Fund Your Traffic Source</div><div class="vd">Add funds to your Caterpillar publisher account so ads can run</div></div></div>
  <div class="video-slot" data-vidalytics-id="RLAZ22kFspRtI1A3" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">T6 — Add Your Landing Pages in DIYTrax</div><div class="vd">Tell DIYTrax which landing pages to rotate traffic between</div></div></div>
  <div class="video-slot" data-vidalytics-id="YJI5apPmvQBdn13r" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">T7 — Place Affiliate Link in DIYTrax Campaign Offer Pages</div><div class="vd">Add your affiliate link so DIYTrax knows where to send buyers</div></div></div>
  <div class="video-slot" data-vidalytics-id="DYnYK_Drhg1FKu7A" data-status="awaiting-link"><div class="play-icon"></div><div><div class="vt">T8 — Final QA Campaign Check and Set To Go Live</div><div class="vd">A final review of every element before flipping the switch</div></div></div>
