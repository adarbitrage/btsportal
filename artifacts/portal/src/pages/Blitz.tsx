...
<span id="s1" style="display:block;position:relative;top:-80px;visibility:hidden;"></span><div class="module" id="welcome" data-section="s1">
  ...
  <div class="video-slot" data-vidalytics-id="x_8mSUUqDIhXNyQP"><div class="play-icon"></div><div><div class="vt">Watch This First: What Is Affiliate Arbitrage?</div><div class="vd">A short overview of how this business model works — start here before anything else</div></div></div>
...
<span id="s2" style="display:block;position:relative;top:-80px;visibility:hidden;"></span><div class="module" id="module0" data-section="s2">
  ...
  <div class="card">
    ...
    <table style="margin:0;">
      ...
      <tbody>
        <tr>
          <td><strong>Phase 2 — Round 1</strong></td>
          <td>$500</td>
          <td>~$100 (20% ROAS)</td>
        ...
        <tr>
          <td><strong>Phase 2 — Round 2</strong></td>
          <td>$500</td>
          <td>~$375 (75% ROAS)</td>
        ...
        <tr>
          <td><strong>Phase 2 — Round 3</strong></td>
          <td>$1,000</td>
          <td>~$600 (60% ROAS)</td>
...
<div class="module" id="blitz-step3" data-section="s7">
  ...
  <div class="path-block mm">
    ...
    <div class="video-slot" data-vidalytics-id="n413KFVaotcczNzk"><div class="play-icon"></div><div><div class="vt">MM1 — What You Need For A MetricMover™ Test</div><div class="vd">Overview of assets and setup requirements before you begin</div></div></div>
    <div class="video-slot" data-vidalytics-id="l0TgiVD_OdVGOU6F"><div class="play-icon"></div><div><div class="vt">MM2 — Creating A New MetricMover™ Campaign</div><div class="vd">Set up your campaign in the MetricMover™ App</div></div></div>
    <div class="video-slot" data-vidalytics-id="UEiQJPY24RnBOfGx"><div class="play-icon"></div><div><div class="vt">MM3 — How To Import Your Landing Page Into MetricMover™</div><div class="vd">Bring your Flexy™ advertorial page into the MetricMover™ App</div></div></div>
    <div class="video-slot" data-vidalytics-id="BB7O9GHighklpI3O"><div class="play-icon"></div><div><div class="vt">MM4 — How To Create Headline Variants</div><div class="vd">Enter your 5 headlines into MetricMover™</div></div></div>
    <div class="video-slot" data-vidalytics-id="_c7Qa_byz0CfONui"><div class="play-icon"></div><div><div class="vt">MM5 — How To Upload Hero Shots To Flexy™</div><div class="vd">Add your 5 hero shot images to your Flexy™ media library</div></div></div>
    <div class="video-slot" data-vidalytics-id="qkPlOP6igjZmTCsU"><div class="play-icon"></div><div><div class="vt">MM6 — How To Create Hero Shot Variants</div><div class="vd">Assign your hero shots as variants in MetricMover™</div></div></div>
    <div class="video-slot" data-vidalytics-id="fG6txxvBGHX_I0P2"><div class="play-icon"></div><div><div class="vt">MM7 — How To Set Up A Flexy™ Page For MetricMover™ Code</div><div class="vd">Prepare your landing page to receive the MetricMover™ code</div></div></div>
    <div class="video-slot" data-vidalytics-id="B9N7Nq7HExNNT7sq"><div class="play-icon"></div><div><div class="vt">MM8 — How To Export MetricMover™ Campaign Files</div><div class="vd">Download your campaign files from the MetricMover™ App</div></div></div>
    <div class="video-slot" data-vidalytics-id="Gyuer8rxri5u3c0b"><div class="play-icon"></div><div><div class="vt">MM9 — How To Find Your MetricMover™ Code File</div><div class="vd">Locate the code file within your exported campaign files</div></div></div>
    <div class="video-slot" data-vidalytics-id="ROrMoUEMt02rNHsp"><div class="play-icon"></div><div><div class="vt">MM10 — How To Embed MetricMover™ Code Into A Flexy™ Page</div><div class="vd">Paste the code into your Flexy™ page to activate the split test</div></div></div>
    <div class="video-slot" data-vidalytics-id="fk8imXc3X0oFntJC"><div class="play-icon"></div><div><div class="vt">MM11 — How To Check MetricMover™ Page Variants</div><div class="vd">Verify that all 25 combinations are displaying correctly</div></div></div>
    <div class="video-slot" data-vidalytics-id="nfxAtCnkhY7LSoud"><div class="play-icon"></div><div><div class="vt">MM12 — How To Find Your MetricMover™ .csv File For DIYTrax™ Import</div><div class="vd">Locate the file you'll need for the next step</div></div></div>
    <div class="video-slot" data-vidalytics-id="7rsmtTDD2Nq68qlY"><div class="play-icon"></div><div><div class="vt">MM13 — How To Import MetricMover™ Page Variants Into DIYTrax™</div><div class="vd">Load all 25 landing page variants into your DIYTrax campaign</div></div></div>
  </div>
...
<div class="module" id="blitz-step5" data-section="s9">
  ...
  <div class="video-slot" data-vidalytics-id="FwUJLd9L5HAonTB1"><div class="play-icon"></div><div><div class="vt">T2 — Configure Caterpillar Traffic Source Settings</div><div class="vd">Connect and configure your Caterpillar publisher settings</div></div></div>
  <div class="video-slot" data-vidalytics-id="a_AOXzP900ghMtxg"><div class="play-icon"></div><div><div class="vt">T3 — Create Your First Native Ad in Caterpillar</div><div class="vd">Upload your first headline, description, and image</div></div></div>
  <div class="video-slot" data-vidalytics-id="zP9oZsPJgMgXTUKJ"><div class="play-icon"></div><div><div class="vt">T4 — Create More Ads in Caterpillar</div><div class="vd">Add your remaining headlines to complete all 10 ads</div></div></div>
  <div class="video-slot" data-vidalytics-id="asSx55NQbclVdP89"><div class="play-icon"></div><div><div class="vt">T5 — Fund Your Traffic Source</div><div class="vd">Add funds to your Caterpillar publisher account so ads can run</div></div></div>
...
<div class="module" id="blitz-round1" data-section="s10">
  ...
  <h4>Phase 2 — Round 1 Exit Gate</h4>
  ...
  <h4>Phase 2 — Round 1 Typical Outcome</h4>
  <div class="card">
    <table>
...
<span id="s11" style="display:block;position:relative;top:-80px;visibility:hidden;"></span><div class="module" id="blitz-between-r1-r2" data-section="s11">
  ...
  <h4>Phase 2 — Round 2 Landing Page Prep</h4>
  <div class="path-block mm">
