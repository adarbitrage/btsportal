...
import adminAdSpendReconciliationRouter from "./admin-ad-spend-reconciliation";
...
import kbFindRouter from "./admin/kb-find.js";
...
import creativeDriveRouter from "./creative-drive";
import resourceHubRouter from "./resource-hub";
import swipeBankRouter from "./swipe-bank";
...
router.use(campaignChecklistRouter);
...
router.use(adminAdSpendReconciliationRouter);
...
router.use(creativeDriveRouter);
router.use(resourceHubRouter);
router.use(swipeBankRouter);
