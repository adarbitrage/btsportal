...
describe("FK exhaustiveness guard — every FK referencing users must be classified", () => {
  ...
  it("every FK constraint referencing users.id is classified in the delete pipeline", async () => {
    ...
    const knownConstraints = new Set<string>([
      ...
      "bts_house_term_aliases_created_by_fkey",
      "kb_flag_resolutions_resolved_by_users_id_fk",
      "kb_highlight_dismissals_dismissed_by_users_id_fk",
      ...
      "kb_nav_gap_flags_dismissed_by_fkey",
      "kb_proposed_synonyms_reviewed_by_fkey",
      ...
      "campaign_checklist_progress_user_id_users_id_fk",
      ...
      "fe_intensive_bookings_member_id_users_id_fk",
