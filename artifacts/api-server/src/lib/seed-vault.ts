  ...
  const resources = await db.insert(vaultResourcesTable).values([
    {
      ...
      tags: JSON.stringify(["facebook", "ads", "copy", "template"]),
      isFeatured: true,
    ...
    },
    {
      ...
      tags: JSON.stringify(["native", "ads", "brief", "template"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 2,
    },
    {
      ...
      tags: JSON.stringify(["landing-page", "bridge", "html", "template"]),
      isFeatured: true,
      requiredEntitlement: "content:frontend",
      sortOrder: 1,
    },
    {
      ...
      fileSize: 890000,
      fileType: "application/pdf",
      tags: JSON.stringify(["headlines", "copy", "formulas", "swipe"]),
      isFeatured: true,
      requiredEntitlement: "content:frontend",
      sortOrder: 1,
    },
    {
      ...
      fileSize: 156000,
      fileType: "application/pdf",
      tags: JSON.stringify(["email", "sequence", "followup", "swipe"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 1,
    },
    {
...
- Campaign Launch SOP`,
      tags: JSON.stringify(["case-study", "health", "facebook", "scaling"]),
      isFeatured: true,
...
4. Weekend traffic converts differently — adjust bids accordingly`,
      tags: JSON.stringify(["case-study", "native-ads", "finance", "scaling"]),
      requiredEntitlement: "content:advanced",
      sortOrder: 2,
    },
    {
...
- [ ] Begin narrowing targeting based on data`,
      tags: JSON.stringify(["sop", "campaign", "launch", "checklist"]),
      requiredEntitlement: "content:advanced",
      sortOrder: 1,
    },
    {
...
- Note any anomalies for morning review`,
      tags: JSON.stringify(["sop", "daily", "management", "campaign"]),
      requiredEntitlement: "content:advanced",
      sortOrder: 2,
    },
    {
      ...
      fileSize: 340000,
      fileType: "application/pdf",
      tags: JSON.stringify(["facebook", "targeting", "cheat-sheet", "ads"]),
      isFeatured: true,
      requiredEntitlement: "content:frontend",
      sortOrder: 1,
    },
    {
      ...
      fileSize: 210000,
      fileType: "application/pdf",
      tags: JSON.stringify(["copywriting", "words", "cheat-sheet"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 2,
    },
    {
      ...
      tags: JSON.stringify(["video", "facebook", "pixel", "tracking"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 1,
    },
    {
      ...
      type: "video",
      videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
      tags: JSON.stringify(["video", "spy-tools", "research", "ads"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 2,
    },
    {
      ...
      tags: JSON.stringify(["calculator", "roi", "spreadsheet", "tool"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 1,
    },
    {
      ...
      fileSize: 92000,
      fileType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
      tags: JSON.stringify(["budget", "planner", "spreadsheet", "tool"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 2,
    },
    {
      ...
      fileSize: 25000000,
      fileType: "application/zip",
      tags: JSON.stringify(["images", "stock", "health", "creative"]),
      requiredEntitlement: "content:advanced",
      sortOrder: 1,
    },
    {
...
5. Stay updated on platform policy changes`,
      tags: JSON.stringify(["compliance", "ftc", "guide", "legal"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 1,
    },
    {
...
Pick ONE traffic source and master it before diversifying. Most BTS members find success starting with Facebook Ads.`,
      tags: JSON.stringify(["traffic", "guide", "selection", "platforms"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 2,
    },
    {
      ...
      tags: JSON.stringify(["tools", "tracking", "recommendations"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 1,
    },
    {
      ...
      tags: JSON.stringify(["images", "free", "resources", "tools"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 2,
    },
    {
      ...
      fileSize: 95000,
      fileType: "application/pdf",
      tags: JSON.stringify(["tracking", "utm", "cheat-sheet", "reference"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 3,
    },
    {
      ...
      fileSize: 198000,
      fileType: "application/pdf",
      tags: JSON.stringify(["google", "ads", "copy", "template"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 3,
    },
    {
      ...
      fileSize: 134000,
      fileType: "application/pdf",
      tags: JSON.stringify(["email", "welcome", "sequence", "swipe"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 2,
    },
    {
      ...
      type: "video",
      videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
      tags: JSON.stringify(["video", "funnel", "tutorial", "beginner"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 3,
    },
    {
      ...
      fileSize: 65000,
      fileType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
      tags: JSON.stringify(["calculator", "split-test", "ab-test", "tool"]),
      requiredEntitlement: "content:frontend",
      sortOrder: 3,
    },
  ]).returning();
