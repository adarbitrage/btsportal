...
*Image Foundations · Document 8 of 8*

---

## Seven Documents, One Motion

You now have the whole toolkit. You know what each surface asks an image to do, how a thumbnail earns a glance, how faces and hands pull attention, where honest curiosity ends and bait begins, why UGC beats polish, how color works against the feed, and which seven images will end a campaign. That's a lot of doctrine to carry into a moment that, in practice, lasts about ninety seconds: *"I need an image for this ad — now what?"*
...
The same image can be exactly right on one surface and flatly wrong on another. Before you judge a single candidate, decide where this image is going to live.

There are three places it can live, and each asks a different job of it. The **native ad thumbnail** has to win qualified attention from a cold scroller who owes you nothing. The **advertorial image** has to confirm the scent the click was chasing — to reassure a reader who just arrived that they're in the right place. The **jump page (bridge page) image** has to support the promise with credibility for a reader who's nearly ready to act. Cold, warming, warm — three different readers, three different jobs.

This is where the workflow visits the surfaces, so it's worth naming what's riding on it: every later judgment in this process — which subject, how much polish, how assertive the image is allowed to be — calibrates to the surface's job and the reader's warmth at that point. Get the surface wrong here and you'll make correct-looking decisions in service of the wrong goal. (The full breakdown of each surface's job lives in *Document 1, The Three Jobs of an Ad Image*.)
...
Reach for **a face when the story is about the person and their feeling** — their relief, their skepticism, their quiet satisfaction. And when you choose a face, immediately give its gaze a job, because a face with no job is wasted attention. A *direct gaze* looks out at the reader and does connection and relatability — the "someone like me" handshake. An *aimed gaze* looks at something inside the frame and transfers the reader's attention to whatever the subject is looking at, so the reader ends where you want them to end.

Reach for **hands doing something when the story is about the doing** — the mechanism, the ritual, the moment of use — and remember that this explicitly includes first-person point of view, the reader's-own-hands framing that puts them inside the moment. This device is a peer of the face, not a fallback. An object sitting alone is a product shot; the same object in a hand is a *moment*, and moments are what stop scrolls. If your angle is about how something is used or what using it feels like, hands will almost always beat a face.

(The craft rules for both devices — shoulders-up crops, one face, one hand-action, expression matched to the promise — live in *Document 2, Faces, Gaze, and Hands*.)
...
Now, and only now — angle set, surface chosen, subject and reveal decided — do you actually produce candidates. And you produce them in the default register: **UGC-style.**
...
Judge the shortlist at the size and setting where it will actually be seen: thumbnail size, on a phone, in a feed. Not blown up on your monitor where every candidate looks competent. At real render size, most of them won't.
...
And an image that passes is **done.** That's the last step. Chosen, checked, and ready for its surface — the workflow ends here. There is no step eight. You don't loop back, you don't add a stage, you don't keep tinkering. Seven steps in, you have an image you can trust, and trusting the process means knowing when it's finished. Ship it to its surface and move on to the next angle — which, because you now know how, starts the seven steps over again.

## Key Takeaways

- The process runs in one direction: angle → surface → subject → reveal → generate → glance test → compliance. Each step narrows the field the next one works on, so running them in order is the whole point.
...
- Choose the subject by what the story is about: a face (with a gaze given a job — direct for connection, aimed to transfer attention) when it's about the person, or hands doing something, including first-person POV, when it's about the doing.
...
- Judge the shortlist at phone-thumbnail size; a composition that takes two seconds to parse has lost, and any side-by-side must clear the demanding standard as a single legible unit.
