...
- **Jump page (bridge page) — a face is optional.** This page is a second ad: the reader arrived on one click, still mostly cold, and the page's job is to get the video playing. A face here is a supporting player, not the lead. When you use one, direct gaze plus a credible, composed expression supports the direct promise the headline is making. Overacting here reads as desperation. Hand-led and first-person shots, meanwhile, work on all three — the doing translates everywhere.
